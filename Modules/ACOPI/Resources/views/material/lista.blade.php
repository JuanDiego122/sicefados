@extends('acopi::layouts.master') {{-- Asegúrate de tener un layout base llamado app.blade.php --}}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('acopi.admin.material.update', $material->id) }}" class="btn btn-sm btn-warning">Editar</a>
